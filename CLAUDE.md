...
Migration history (for reference if anything similar comes up): the app was mid-migration to auth.romaine.life delegation when it was retired — see [plant-agent#23](https://github.com/nelsong6/plant-agent/pull/23) and [nelsong6/auth#16](https://github.com/nelsong6/auth/issues/16).
